          ...
          <table className="w-full">
            <thead>
              <tr>
                ...
                <th className="px-4 py-8 text-center bg-[#255036] rounded-t-xl">
                  <span className="px-4 py-2 text-base font-medium text-black bg-[#ffcf40] rounded-full">
                    {" "}
                    Popular{" "}
                  </span>
            ...
            <tbody>
              <tr>
                ...
                <td className="px-4 py-4 text-center text-black bg-white border-b border-gray-black/20">
                  50
                </td>
              ...
              <tr>
                ...
                <td className="px-4 py-6 text-center bg-yellow-500 rounded-b-xl">
                  <a
                    href="#"
                    title=""
                    className="inline-flex items-center font-semibold text-black hover:text-black"
                  >
                    Get Started
                    <svg
                      className="w-4 h-4 ml-1"
